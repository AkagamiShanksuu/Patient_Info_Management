...
class LoginWindow:
    def _init_(self):
        ...
        Button(self.window, text="Login", command=self.login).grid(row=2, column=0, columnspan=2, padx=5, pady=5)
    ...
    def login(self):
        ...
        if username == "admin" and password == "password":
            ...
            self.window.destroy()
            # Create an instance of the InsertWindow class
            InsertWindow()
        else:
...
class InsertWindow:
    ...
    def Update(self):
        self.database = Databasself.window = tkinter.Tk()
        self.window.wm_title("Insert data")
...
class HomePage:
    def _init_(self):
        ...
        self.homePageWindow.configure(bg="#FFBDF7")
